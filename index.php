...
<div id="content" class="page">
	...
	<?php if (have_posts()) : while (have_posts()) : The_post(); ?><!-- Begin CONTENT loop -->
		...
		<small>Posted on <?php the_time('F j, Y'); ?> by <?php the_author(); ?> in <?php the_category(', '); ?></small> <!-- Pulls and places date and time, author, and category of article -->
		<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'thumbnail' ); ?></a> <!-- pulls and places the featured image -->
		<?php get_excerpt(); ?> <!-- Pulls and crams the excerpt for the article -->
